<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.id" placeholder="UID" style="width: 150px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      <el-table-column label="UID" prop="id" sortable="custom" align="center" width="80" :class-name="getSortClass('id')">
      ...
      <el-table-column label="手机号" min-width="40px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.phone }}</span>
        </template>
      </el-table-column>
